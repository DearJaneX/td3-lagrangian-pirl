...
def parse_args():
    ...
    parser.add_argument('--log_dir', type=str, default="logs/MapC/TD3_Lagrangian_04042330", 
...
def contour_plot(x, y, z, key=None, filename=None, use_lagrangian=False):
    ...
    method_name = "TD3-Lagrangian-PIRL" if use_lagrangian else "TD3-PIRL"
...
if __name__ == '__main__':
    ...
    # Safety probability  
    #####################################
    method_name = "lagrangian" if args.use_lagrangian else "standard"
    ...
    print(f"Safety probability analysis completed for TD3-PIRL with {method_name} method.")
