...
if __name__ == '__main__':
    ...
    agentOp = agentOptions(
        ...
        LAMBDA_LR=learning_rate,    # Learning rate for Lagrangian multiplier
        ...
        EPSILON_MIN=0.001,
        USE_LAGRANGIAN=args.use_lagrangian,  # Use command line flag
    ...
    if restart:
        LOG_DIR = "logs/MapC/TD3_Lagrangian_04211248/"  # Set log dir
        ...
        # Add "Lagrangian" to log dir if using the method
        lagrangian_tag = "_Lagrangian" if args.use_lagrangian else ""
        LOG_DIR = f'logs/MapC/TD3{lagrangian_tag}_'+datetime.now().strftime('%m%d%H%M')
        current_ep = None
    ...
    print("="*80)
    print(f"Training TD3-PIRL{' with Lagrangian method' if args.use_lagrangian else ''}")
